...
Welcome to ``vibrate`` contributor's guide.
...
If you experience bugs or general issues with ``vibrate``, please have a look
...
You can help improve ``vibrate`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``vibrate`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``vibrate``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n vibrate python=3 six virtualenv pytest pytest-cov
    conda activate vibrate
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/vibrate.git
    cd vibrate
...
#. Install |pre-commit|_::
   ...
   ``vibrate`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/vibrate
.. _issue tracker: https://github.com/<USERNAME>/vibrate/issues
.. <-- end -->
