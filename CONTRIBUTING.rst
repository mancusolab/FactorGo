...
Welcome to ``FactorGo`` contributor's guide.
...
If you experience bugs or general issues with ``FactorGo``, please have a look
...
You can help improve ``FactorGo`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``FactorGo`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``FactorGo``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n FactorGo python=3 six virtualenv pytest pytest-cov
    conda activate FactorGo
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/FactorGo.git
    cd FactorGo
...
#. Install |pre-commit|_::
   ...
   ``FactorGo`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/FactorGo
.. _issue tracker: https://github.com/<USERNAME>/FactorGo/issues
.. <-- end -->
